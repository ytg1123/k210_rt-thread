...
#  define irqinfo(format, ...)   dbg_log_line("D", 0, fmt, ##__VA_ARGS__)
#else
#  define irqinfo(x...)
#endif

#ifdef CONFIG_DEBUG_IRQ_ERROR
#  define irqerr(format, ...)     dbg_log_line("D", 0, fmt, ##__VA_ARGS__)
#else
#  define irqerr(x...)
#endif

#ifdef CONFIG_DEBUG_IRQ_WARN
#  define irqwarn(format, ...)   dbg_log_line("D", 0, fmt, ##__VA_ARGS__)
#else
#  define irqwarn(x...)
#endif
