...
#if KPU_DEBUG
    printf("KPU: kpu_load_from_buffer 1 \n");
#endif
...
#if KPU_DEBUG
    printf("KPU: kpu_load_from_buffer 2 \n");
#endif
...
#if KPU_DEBUG
    printf("KPU: kpu_load_from_buffer 3 \n");
#endif
...
int kpu_load_kmodel(kpu_model_context_t *ctx, const uint8_t *buffer)
{
...
#if KPU_DEBUG
    printf("KPU: kpu_load_model 2 ctx->main_buffer=0x%x \n",ctx->main_buffer);
#endif
        if(!ctx->main_buffer)
            return -1;

#if KPU_DEBUG
    printf("KPU: kpu_load_model 3 \n");
#endif
    ...
    {
#if KPU_DEBUG
    printf("KPU: kpu_load_model 5 \n");
#endif
        return nncase_load_kmodel(ctx, buffer);
    } else
    {
#if KPU_DEBUG
    printf("KPU: kpu_load_model 6 \n");
#endif
        return -1;
    }
#if KPU_DEBUG
    printf("KPU: kpu_load_model 7 \n");
#endif
