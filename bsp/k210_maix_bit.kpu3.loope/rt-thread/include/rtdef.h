...
typedef unsigned int                    __u32;          /**< 32bit unsigned integer type */
...
//typedef unsigned long fdt_size_t ;


typedef unsigned char                   _Bool8; 	/**<  8bit unsigned integer type */
#define bool _Bool8
#define true  (bool)1
#define false (bool)0

typedef unsigned int       		rt_uintptr_t;
