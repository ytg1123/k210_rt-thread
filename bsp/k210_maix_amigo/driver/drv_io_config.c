...
#elif (BOARD_AMIGO_2970==1)
    IOCONFIG(BSP_SPI1_CLK_PIN, FUNC_SPI1_SCLK),          /* 11 */
    IOCONFIG(BSP_SPI1_D0_PIN, FUNC_SPI1_D0),             /* 10 */
    IOCONFIG(BSP_SPI1_D1_PIN, FUNC_SPI1_D1),             /* 06 */
    IOCONFIG(BSP_SPI1_SS0_PIN, FUNC_GPIOHS7),            /* 26 */
    //IOCONFIG(BSP_SPI1_SS0_PIN, FUNC_GPIOHS2),            /* 29 */
...
#elif defined(BSP_USING_MAIXAMIGO)
    IOCONFIG(35, FUNC_I2S0_IN_D0),
    IOCONFIG(18, FUNC_I2S0_WS),
    IOCONFIG(21, FUNC_I2S0_SCLK),
...
void io_mux_init(void) {
    ...
    //set io mux
    //fpioa_set_function(30, FUNC_I2C0_SCLK + ES8374_I2C_DEVICE * 2);
    //fpioa_set_function(31, FUNC_I2C0_SDA  + ES8374_I2C_DEVICE * 2);
