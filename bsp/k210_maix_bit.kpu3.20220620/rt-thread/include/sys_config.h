...
extern unsigned int script_parser_fetch_subkey_start(char *main_name);
extern int script_parser_fetch_subkey_next(unsigned int hd, char *sub_name, int value[], int *index);
...
extern unsigned int script_parser_subkey( script_main_key_t* main_name,char *subkey_name , unsigned int *pattern);

extern int script_parser_patch_all(char *main_name, void *str, unsigned int data_count);
